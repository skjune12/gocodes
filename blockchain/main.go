...
type Block struct {
	...
	Timestamp string `json:"timestamp"` // automatically determined and is the time the data is written
	Data      int    `json:"data"`      // data
	Hash      string `json:"hash"`      // SHA256 identifier representing this data record
	PrevHash  string `json:"prevhash"`  // SHA256 identifier of the previous record in the chain
}
